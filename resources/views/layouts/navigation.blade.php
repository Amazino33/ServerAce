<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                        ...
                        <x-dropdown align="right" width="48">
                            ...
                            <x-slot name="content">
                                @foreach ($menuCat as $cat)
                                    <x-dropdown-link :href="route('category.show', $cat->slug)"
                    ...
                    @auth
                    <x-nav-link :href="route('post-gig')" :active="request()->routeIs('post-gig')">
                        {{ __('Post a Gig') }}
                    </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @auth
            <x-responsive-nav-link :href="route('post-gig')" :active="request()->routeIs('post-gig')">
                {{ __('Post a Gig') }}
            </x-responsive-nav-link>
