        ...
        @if(auth()->user()->needsPaymentSetup())
            ...
            <div class="mb-6 bg-gradient-to-r from-yellow-400 to-orange-500 rounded-xl shadow-lg p-6">
                <div class="flex items-start gap-4">
                    <div
                        class="w-12 h-12 bg-white bg-opacity-20 rounded-full flex items-center justify-center flex-shrink-0">
                        <i class="fas fa-exclamation-triangle text-white text-xl"></i>
                    </div>
                    <div class="flex-1">
                        <h3 class="text-xl font-bold text-white mb-2">
                            ⚠️ Set Up Payments to Get Paid
                        </h3>
                        <p class="text-white text-opacity-90 mb-4">
                            You need to connect your bank account before you can receive payments from clients.
                            This is a one-time setup and only takes 2-3 minutes.
                        </p>
                        <a href="{{ route('freelancer.stripe.onboarding') }}"
                            class="inline-flex items-center gap-2 bg-white text-orange-600 font-bold py-3 px-6 rounded-lg hover:bg-gray-100 transition shadow-lg">
                            <i class="fas fa-university"></i>
                            <span>Set Up Payment Account Now</span>
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-white text-opacity-90">
                                You're all set to receive payments. Start applying to gigs and get paid!
                            </p>
                        </div>
                    </div>
                </div>
                        ...
                        <form wire:submit.prevent="submitApplication">
                            ...
                            <div class="mb-6">
                                ...
                                <div class="relative">
                                    ...
                                    <input type="number" wire:model="proposedPrice" step="0.01" min="1"
                ...
                <div class="bg-white rounded-2xl shadow-2xl max-w-3xl w-full mx-4 max-h-screen overflow-y-auto">
                    ...
                    <div class="p-8">
                        ...
                        <div class="bg-gray-50 rounded-xl p-4 mb-6">
                            ...
                            <a href="{{ route('gigs.show', $selectedApplication->gig->slug) }}" target="_blank"
